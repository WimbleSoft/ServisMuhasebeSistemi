        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Personel Düzenleme Ekranı</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<?php
			$vericek=$connection->query("select * from personel where id='$personelid'")->fetchAll(PDO::FETCH_ASSOC);
			foreach ($vericek as $vcek)
			{
			?>
			<form role="form" method="post" enctype="multipart/form-data" action="personel-guncelle.php">
			  <div class="box-body">
